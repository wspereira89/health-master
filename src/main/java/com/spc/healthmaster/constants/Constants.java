...
public final class Constants {
    ...
    public static final String ALREADY_EXIST_SERVER_MANAGER = "already_exist_server_manager";
    public static final String ALREADY_EXIST_APPLICATION= "already_exist_application";
