...
public final class SwaggerCommandResponseConstants {
    ...
    public static final String COMMAND_RESPONSE_SUCCESS_STOPPED ="{\n" +
            " \"status\":\"STOPPED\",\n" +
            " \"fileDtoList\":\"null\",\n" +
            " \"download\":\"null\",\n" +
            "}";
    public static final String COMMAND_RESPONSE_SUCCESS_UNDEFINED ="{\n" +
            " \"status\":\"UNDEFINED\",\n" +
            " \"fileDtoList\":\"null\",\n" +
            " \"download\":\"null\",\n" +
            "}";

    public static final String COMMAND_RESPONSE_SUCCESS_LOG ="{\n" +
            " \"status\":\"null\",\n" +
            "  \"fileDtoList\":[\n" +
            ...
            "\"download\":\"null\"\n" +
            "}";
    public static final String COMMAND_RESPONSE_ERROR_400_ARGUMENTS_NOT_VALID = "{\n" +
    ...
    public static final String COMMAND_ERROR_400_DESERIALIZATION_COMMAND = "{\n" +
    ...
    public static final String COMMAND_ERROR_400_DESERIALIZATION_TYPE_STRATEGY = "{\n" +
            "  \"error\":\"deserialization_error\",\n" +
            "  \"message\":\"JSON deserialization error\",\n" +
            "  \"status\":400,\n" +
            "  \"causes\":[\n" +
